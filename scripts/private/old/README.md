...
folder `uscope-snapshots`, which then contains an additional folder called `sandbox`.
...
- **snaphot.sh**: Run this script to generate the `uscope-snapshots` folder, containing
