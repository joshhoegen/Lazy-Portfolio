...
aggr.factory('aggr', function() {
...
}).controller('aggrList', ['$scope', '$sce', '$http', '$routeParams', 'aggr', 'getSoundcloud', 'getInstagram',
    function($scope, $sce, $http, $routeParams, aggr, getSoundcloud, getInstagram) {
        ...
        var mobilecheck = function() {
            ...
            instagram = getInstagram.getImages(conf('instagram'), (mobilecheck ? 8 : 12)),
            scTracks = getSoundcloud.getTracks(conf('soundcloud'), (mobilecheck ? 4 : 8));
        instagram.then(
            function(images) {
                var output = [];
