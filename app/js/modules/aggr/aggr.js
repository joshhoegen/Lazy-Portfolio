...
aggr.controller('aggrList', ['$scope', '$sce', '$http', '$routeParams', 'aggr', 'getSoundcloud', 'getInstagram',
    function($scope, $sce, $http, $routeParams, aggr, getSoundcloud, getInstagram) {
        $scope.aggr = [];
        // Move to seutp module
        ...
        var mobilecheck = function() {
            ...
            instagram = getInstagram.getImages((mobilecheck ? 8 : 12)),
            scTracks = getSoundcloud.getTracks('http://soundcloud.com/byutifu/tracks', (mobilecheck ? 4 : 8));
        instagram.then(
            function(images) {
                var output = [];
